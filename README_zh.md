...
仓库按年份组织，每年包含各选题 (A, B, C, D, E, F) 的子目录。每个 PDF 文件以论文控制号命名 (例如 `12345.pdf`)。
...
本仓库资料整理自网络资源，仅用于同学们备战美赛参考论文思路使用，欢迎讨论、学习交流。如有侵权，请联系作者删除。本仓库仅用于学习交流使用，不得用于其他商业目的。仓库作者与原作者无任何关系，不承担任何责任。
